...
//
//=========================================================
CSquadMonster *CSquadMonster::MySquadLeader(void) 
{ 
...
//
//=========================================================
CSquadMonster *CSquadMonster::MySquadMember(int i)
{ 
...
// Killed
//=========================================================
void CSquadMonster::Killed(CBaseEntity *pInflictor, CBaseEntity *pAttacker, int iGib)
{
	VacateSlot();
...
{
	ASSERT(pEnemy != NULL);
//	ALERT(at_console, "CSquadMonster(%s)::CheckEnemy(%s)\n", STRING(pev->classname), STRING(pEnemy->pev->classname));

	int iUpdatedLKP = CBaseMonster::CheckEnemy(pEnemy);// XDM3035c: was m_hEnemy
...
// XDM: UNTESTED
//=========================================================
void CSquadMonster::SquadUnlink(void)
{
	m_hSquadLeader = NULL;
	m_iMySlot = bits_NO_SLOT;
}
...
// XDM: UNTESTED
//=========================================================
void CSquadMonster::SquadDisband(void)
{
	for (int i = 0; i < MAX_SQUAD_MEMBERS-1; i++)
	{
		CSquadMonster *pMember = MySquadMember(i);
