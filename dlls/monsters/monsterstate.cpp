...
// SetMonsterState
//=========================================================
void CBaseMonster :: SetMonsterState ( MONSTERSTATE State )
{
/*
...
//	ALERT(at_console, "RunAI() 1\n");
		 ...
		 m_MonsterState != MONSTERSTATE_DEAD )// don't bother with this crap if monster is prone. 
	{
		...
		{
//			ALERT(at_console, "RunAI() 1a\n");
			Look(m_flDistLook);
//			ALERT(at_console, "RunAI() 1b\n");
			Listen();// check for audible sounds. 
			// now filter conditions.
			ClearConditions( IgnoreConditions() );
//			ALERT(at_console, "RunAI() 1c\n");
			GetEnemy();
		}

//		ALERT(at_console, "RunAI() 1d\n");
		// do these calculations if monster has an enemy.
		if (m_hEnemy != NULL)
			CheckEnemy(m_hEnemy);

//		ALERT(at_console, "RunAI() 1e\n");
		CheckAmmo();
	}
//	ALERT(at_aiconsole, "RunAI() 2\n");
	FCheckAITrigger();
//	ALERT(at_aiconsole, "RunAI() 3\n");
	PrescheduleThink();
//	ALERT(at_aiconsole, "RunAI() 4\n");
	MaintainSchedule();
