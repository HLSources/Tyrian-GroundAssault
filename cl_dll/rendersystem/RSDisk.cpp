...
CRSDisk::CRSDisk(const Vector &origin, const Vector &angles, const Vector &anglesdelta, float radius, float radiusdelta, unsigned short segments, int sprindex, int r_mode, byte r, byte g, byte b, float a, float adelta, float timetolive)
{
