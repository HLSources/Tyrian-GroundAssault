...
//		CON_PRINTF("CRSBeamStar::Update(): m_fScale = %f, m_fBrightness = %f, dying = %d\n", m_fScale, m_fBrightness, dying);
	}
	return dying;
}
...
//	if (gHUD.m_iPaused <= 0)// || CL_IsThirdPerson())
	{
...
//		VectorAdd(m_vecAngles, ev_punchangle, m_vecAngles);
	...
	if (lines == 1)//Special for BeamStar - another draw mode!
