...
public:
	...
	unsigned int AddSystem(CRenderSystem *pSystem, int flags = 0, int followentindex = -1, int followflags = 0/*, float delay = 0.0f*/);
...
private:
	CRenderSystem *m_pFirstSystem;// LIFO RS list. NEVER reorder it manually!
};
