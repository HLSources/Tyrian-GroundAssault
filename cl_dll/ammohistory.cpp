...
#define AMMO_PICKUP_GAP				(gHR.iHistoryGap+24)
#define AMMO_PICKUP_PICK_HEIGHT		(32 + (gHR.iHistoryGap * 2))
#define AMMO_PICKUP_HEIGHT_MAX		(ScreenHeight - 100)
#define MAX_ITEM_NAME	32
float HISTORY_DRAW_TIME = 5.0f;
...
void HistoryResource::AddToHistory(const int &iType, const char *szName, const int &iCount)
{
...
//				else
//					CON_PRINTF("No sprite for ammo ID %d!\n", rgAmmoHistory[i].iId);
			...
			{
				HUD_WEAPON *weap = gWR.GetWeapon(rgAmmoHistory[i].iId);
